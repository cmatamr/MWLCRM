  ...
  return (
    <section className="rounded-[28px] border border-white/70 bg-white/90 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] xl:min-h-[260px]">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        <article className="rounded-[24px] border border-border/70 bg-slate-50/70 p-4 xl:min-h-[84px]">
        ...
        <article className="rounded-[24px] border border-primary/15 bg-primary/[0.07] p-4 xl:min-h-[84px]">
